...
},
{
  ...
  "number": "",
  "title": "Slideshows",
  "body": " Slideshows  Slides for each section are available in HTML format.    LE     LE1 slides      LE2 slides      LE3 slides      LE4 slides       EV     EV1 slides      EV2 slides      EV3 slides      EV4 slides      EV5 slides      EV6 slides      EV7 slides       AT     AT1 slides      AT2 slides      AT3 slides      AT4 slides       VS     VS1 slides      VS2 slides       MX     MX1 slides      MX2 slides      MX3 slides       GT     GT1 slides      GT2 slides      GT3 slides      GT4 slides       Applications     Civil Engineering slides      Computer Science slides      Geology slides       "
},
{
  "id": "LE1",
  "level": "1",
...
},
{
  ...
  "number": "2.1.4",
  "title": "",
  "body": "  Consider .   Sketch the four Euclidean vectors in the plane.  Sketch a representation of all the vectors belonging to in the plane.  "
},
{
  "id": "activity-27",
  "level": "2",
  ...
  "number": "2.1.5",
  "title": "",
  "body": "  Consider .   Sketch the following five Euclidean vectors in the plane.    Sketch a representation of all the vectors belonging to in the plane.  "
},
{
  "id": "activity-28",
  "level": "2",
...
},
{
  "id": "activity-165",
  "level": "2",
  "url": "pagerank.html#activity-165",
  "type": "Activity",
  "number": "A.2.1",
...
},
{
  "id": "activity-166",
  "level": "2",
  "url": "pagerank.html#activity-166",
  "type": "Activity",
  "number": "A.2.5",
  "title": "",
...
},
{
  "id": "sample-VS1",
  "level": "2",
  "url": "sample-exercises.html#sample-VS1",
  "type": "Example",
  "number": "B.1.16",
  "title": "VS1.",
...
},
{
  "id": "sample-VS2",
  "level": "2",
  "url": "sample-exercises.html#sample-VS2",
  "type": "Example",
  "number": "B.1.17",
  "title": "VS2.",
  "body": "VS2     Given the set write a statement involving the solutions to a polynomial equation that's equivalent to each claim below.    The set of polynomials is linearly independent .    The set of polynomials is linearly dependent .      Explain how to determine which of these statements is true.      The set of polynomials is linearly independent exactly when the polynomial equation has no nontrivial (i.e. nonzero) solutions. The set is linearly dependent when this equation has a nontrivial (i.e. nonzero) solution.  To solve this equation, we distribute and then collect coefficients to obtain . These polynomials are equal precisely when their coefficients are equal, leading to the system .  To solve this, we compute   The system has (infintely many) nontrivial solutions, so we that the set of polynomials is linearly dependent .   "
},
{
  "id": "sample-MX1",
  "level": "2",
