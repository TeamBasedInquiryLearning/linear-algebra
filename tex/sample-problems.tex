...
\begin{center}
\Large \textbf{Sample Assessment Problems}
\end{center}

This document contains one problem and solution for each standard.  
The goal is to give you an idea of what the problems will look like, 
...
\begin{solution}
\[
  \RREF \left(\begin{bmatrix}[ccc|c] 2 & 4 & 1 & 5 \\ 1 & 2 & 0 & 3 \end{bmatrix} \right) = 
...
\[
  \left\{ \begin{bmatrix} 3-2a \\ a \\ -1 \end{bmatrix} \,\middle|\, a \in \IR \right\}
\]
\end{solution}
