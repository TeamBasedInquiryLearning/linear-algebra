...
\item State the definition of a spanning set, and determine if a set of vectors spans a vector space or subspace \standardList{V3}.
\item State the definition of linear independence, and determine if a set of vectors is linearly dependent or independent \standardList{S1}.
\item State the definition of a basis, and determine if a set of vectors is a basis \standardList{S2}.
