...
\begin{problem}{A1}
Determine if $D: M_{2,2} \rightarrow \IR$ given by $D\left(\begin{bmatrix} a & b \\ c & d \end{bmatrix} \right) = a-3c$ is a linear transformation or not.
\end{problem}
...
\begin{problem}{A1}
Determine if the map $T: \P^3 \rightarrow \IR^2$ given by $T(f(x))=\begin{bmatrix} f(0) \\ f(3) \end{bmatrix}$ is a linear transformation or not.
\end{problem}

\begin{problem}{A1}
Determine if the map $T: \IR^2 \rightarrow \P^2$ given by $T\left(\begin{bmatrix} a \\b \end{bmatrix} \right)= ax^2+b $ is a linear transformation or not.
\end{problem}
