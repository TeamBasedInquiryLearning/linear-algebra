...
\[
  \begin{bmatrix} 1 & 0 & 0 \\ 0 & 1 & 0 \end{bmatrix}
\]
has a non-pivot column. Similarly, the \(\RREF\) of the surjective map's
standard matrix
\[
  \begin{bmatrix} 1 & 0 \\ 0 & 1 \\ 0 & 0 \end{bmatrix}
\]
has a non-pivot (zero) row.
\end{observation}
...
\) to find a system of equations whose solution set is the kernel.
\end{subactivity}
\begin{subactivity}
