...
\[
  A_2=\begin{bmatrix}2&3\\0&4\end{bmatrix}\hspace{2em}
  B_2=\begin{bmatrix}3&2\\4&0\end{bmatrix}
\]
\begin{center}
\begin{tikzpicture}[scale=0.5]
\fill[red!50!white] (0,0) rectangle (1,1);
...
\draw[thin,gray,<->] (-4,0)-- (4,0);
\draw[thin,gray,<->] (0,-4)-- (0,4);
\draw[thick,blue,->] (0,0) -- node[below] {$B_2 \vec{e}_2= \begin{bmatrix}2 \\ 0 \end{bmatrix}$}++ (2,0);
\draw[thick,blue,->] (0,0) -- ++(3,4) node[above] {$B_2 \vec{e}_1 = \begin{bmatrix} 3 \\ 4 \end{bmatrix}$};
\draw[thick,red,->] (0,0) -- ++(1,0);
\draw[thick,red,->] (0,0) -- ++(0,1);
\draw[blue,dashed] (2,0) -- (5,4) -- (3,4);
\draw[red,dashed] (1,0) -- (1,1) -- (0,1);
