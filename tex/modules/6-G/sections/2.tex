...
\begin{remark}
While a formula might make this \(2\times 2\) determinant easier,
memorizing a formula for \(3\times 3\), \(4\times 4\), or larger determinants
is difficult. So we will start by focusing on how to use row/column operations
on \(3\times 3\) determinants.

\vspace{1em}
 
But rather than always turning the original matrix into \(I\),
let's figure out how to turn the determinant of a larger matrix
