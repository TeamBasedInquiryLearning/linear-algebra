...
\begin{tabular}{@{}ll}
{\bf Course information:}& Math 237--Linear Algebra \\
& Fall 2017 \\
& Course format: Web-enhanced \\
{\bf Meeting times:} & \ifbool{TBL}{\tbltime}{\lecturetime} \\
\end{tabular}
\begin{tabular}{ll}
{\bf Instructor:}& \prof \\
& \profemail \\
...
Vector Spaces & \\ \hline
Structure of Vector Spaces & \\ \hline
...
\begin{enumerate}[1)]
\item Each standard will show up on quizzes for four consecutive weeks, beginning the class day after it is discussed in class (except, of course, standards that we cover in late November).  For example, standards that we cover on \ifbool{TR}{Tuesday, September 5th}{Wednesday, September 6} will appear on quizzes on the next four \ifbool{TR}{Thursdays}{Mondays}, \ifbool{TR}{September 7, 14, 21, and 28}{September 11, 18, 25, and October 3}.  A detailed schedule listing when each standard appears on quizzes is posted in Sakai.
\item There will be a midterm in class on \ifbool{TR}{Tuesday, October 10}{Wednesday, October 11}, a semifinal assessment the last week of class, and the final exam.
...
{\bf Each day we will have a quiz} in the last 15 minutes of class giving you opportunity to master several standards.  Note that you must have participated in class that day to be eligible to take the quiz.  There will also be a {\bf midterm exam on \ifbool{TR}{Tuesday, October 10}{Wednesday, October 11}}, and {\bf the final exam will be \ifbool{TR}{Thursday, December 7 at \ifbool{TBL}{10:30}{1:00}}{\ifbool{TBL}{Monday, December 4 at 6:00}{Wednesday, December 6 at 3:30}}}.
...
\begin{itemize}
\item Obtain 45 mastery checkmarks;
...
\begin{itemize}	
\item Obtain 25 mastery checkmarks;
