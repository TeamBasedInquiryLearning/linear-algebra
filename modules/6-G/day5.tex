...
\begin{enumerate}
\item
%If a webpage is important, there should be other important webpages that link to it.
...
We can summarize the left hand side of the system in the vector $\vect{x}=\begin{bmatrix} x_1 \\ x_2 \\ x_3 \end{bmatrix}$ and the right hand side in following \term{page rank matrix}.
% , in which the columns describes the percentage of links out from the corresponding page into the pages corresponding to each row.
