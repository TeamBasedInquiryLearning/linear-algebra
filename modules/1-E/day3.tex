...
\begin{definition}% TODO not make "memorized" definition, emphasize
  % column process, draw illustration
...
\begin{activity}{10}% subactivty to identify pivot columns
...
\begin{remark}
  In Module TODO, we will %TODO motivate homogeneous
\end{remark}
