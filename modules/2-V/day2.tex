...
\begin{activity}{15}
  ...
  this is not a vector space by finding a combination of vectors and scalars
  that do not satisfy one of the vector space properties.
...
\begin{activity}{10}
  Prove that \(\P^2\) satisfies the \textbf{addition commutivity} property
  of vector spaces,
...
%TODO add an example not belonging to span
