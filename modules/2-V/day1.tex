...
\begin{activity}{25}
  ...
  Prove that \(V\) paired with these operations satisfies all the vector space
  properties.

  \vectorSpaceProperties

  For example, Addition Commutivity may be proven by showing
  \[\vect u\oplus \vect v=(x_1,y_1)\oplus (x_2,y_2)=(x_1+x_2,y_1y_2)
  =(x_2+x_1,y_2y_1)=(x_2,y_2)+(x_1,y_1)=\vect v\oplus \vect u\]
\end{activity}
