...
\item Solve systems of linear equations \standardList{E.3}
\item Find the matrix corresponding to a linear transformation \standardList{A.1}
\item Determine if a linear transformation is injective and/or surjective \standardList{A.3}
